...
public class ArbolB< T extends Comparable<T>> extends ArbolBusquedaMVias<T> {
    ...
    public boolean eliminar(T datoAEliminar) {
        ...
        if (nodoActual.esHoja()) { //nodoActual es hoja 
            removerDatoDelNodo(nodoActual, datoAEliminar);
            ...
            pilaDePadres.push(nodoActual);
            NodoMVias<T> hijoIzquierdoDeDatoAElimnar = nodoActual.getHijo(indice);
            NodoMVias<T> nodoDelPredecesor = buscarNodoDelPredecesor(pilaDePadres, hijoIzquierdoDeDatoAElimnar);
    ...
    /**
     * Pre: el dato ya está en el nodo. No se Considera el exceso.
     *
     * @param nodoActual
     * @param datoAEliminar
     */
    private void removerDatoDelNodo(NodoMVias<T> nodoActual, T datoAEliminar) {
        int posicionDelDato = this.getPosicionDelDato(nodoActual, datoAEliminar);
        this.eliminarDatoDelNodo(nodoActual, posicionDelDato);
    }
    ...
    */
    ...
    /**
     * retorna el nodo que tiene el dato Mayor en el árbol, este nodo siempre es hoja.
     * @param pilaDePadres
     * @param nodoActual
     * @return 
     */
