...
//              }
     ...
     * tambien retorna False si el dato no esta en el nodo o si solo tiene datos vacios(nulos)
     * @param nodoActual
     * @param dato
     * @return
     */
    ...
    /**
     * 1.Precondición: tiene al menos un dato vacio(nulo) = espacio para un dato valido mas. 
     * 2.Precondicion: el dato no existe en el nodoActual.
     * Inserta un dato en orden descedente en el NodoActual
     *
     * @param nodoActual
     * @param datoAInsertar
     */
    ...
    private NodoMVias<T> eliminar(NodoMVias<T> nodoActual, T datoAEliminar) throws Exception {
        ...
        for (int i = 0; i < (orden - 1); i++) {
            ...
            if (datoAEliminar.compareTo(datoDePosicion) == 0) { //si se encontro el dato
                ...
                //Caso 2 o 3
                T datoSucesor = buscarDatoSucesor(nodoActual, i);
                ...
                if (datoAEliminar.compareTo(datoDePosicion) < 0) {
                    NodoMVias<T> nuevoHijo = eliminar(nodoActual.getHijo(i), datoAEliminar);
    ...
    /**
     * elimina el dato de la posicion i Pre : supone que el dato ya esta en el
     * Nodo => aumenta un nodo vacio(nulo)
     *
     * @param nodoActual
     * @param posicion
     */
    ...
    private T buscar(NodoMVias<T> nodoActual, T datoABuscar) {
        ...
        return buscar(nodoActual.getHijo(orden - 1), datoABuscar);
    }
    ...
    public static void main(String arg[]) throws ExceptionArbolOrdenInvalido{
        ArbolBusquedaMVias<Contacto> b = new ArbolBusquedaMVias<>(4);
        Contacto c = new Contacto("fede",234,true);
        
        b.insertar(c);
        Contacto d = new Contacto("jose",344,true);
        b.insertar(d);
        b.insertar(new Contacto("jose",11,true));
        b.insertar(new Contacto("jose",222,true));
        b.insertar(new Contacto("jose",66,true));
        b.insertar(new Contacto("jose",777,true));
        
        System.out.println(b.recorridoPorNiveles());
        System.out.println(b.buscar(d));
